"""Native macOS directories and POSIX process/session behaviour."""
...
PROGRAMS = ("ffmpeg", "pbcopy", "pbpaste", "osascript")
...
def is_our_process(pid, needles):
    ...
    try:
        ...
        return False
    return all(str(needle) in result.stdout for needle in needles)
