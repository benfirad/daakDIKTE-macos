...
# macOS has native adapters for CoreAudio, NSPasteboard, Quartz and Carbon.
# Other POSIX systems still land on Linux, where a missing desktop program is
# reported as a useful runtime error rather than an import failure at startup.
